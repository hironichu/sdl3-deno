...
export class VideoDriver {
  ...
  static get(index: number): string {
    return read_cstr(SDL.getVideoDriver(index));
  }
  ...
  static get current(): string {
    return read_cstr(SDL.getCurrentVideoDriver());
  }
}
/**
 ...
 */
export function systemTheme(): SDL.SYSTEM_THEME {
...
export class Display {
  ...
  get displays(): Display[] | null {
    ...
    while (true) {
      const id = p.i32;
      if (id === 0) break;
      r.push(new Display(id));
    }
    free(displays);
    return r;
  }

  static tryFrom(id: number): Display | null {
    if (id === 0) return null;
   ...
   */
  static get primary(): Display | null {
    return Display.tryFrom(SDL.getPrimaryDisplay());
  }
   ...
   */
  get properties(): number | null {
    const id = SDL.getDisplayProperties(this.id);
    if (id === 0) return null;
    return id;
  }
  /**
  ...
  get name(): string | null {
    const r = SDL.getDisplayName(this.id);
    if (!r) return null;
    return read_cstr(r);
  }
   ...
   */
  get naturalOrientation(): DisplayOrientation {
    return SDL.getNaturalDisplayOrientation(this.id);
  }
  /**
  ...
  get contentScale(): number {
    return SDL.getDisplayContentScale(this.id);
  }
   ...
   */
  fullscreenDisplayModes(): DisplayModePtr[] | null {
    const modes = SDL.getFullscreenDisplayModes(this.id, null);
   ...
   */
  get desktopDisplayMode(): DisplayModePtr | null {
   ...
   */
  get currentDisplayMode(): DisplayModePtr | null {
    const r = SDL.getDesktopDisplayMode(this.id);
    if (!r) return null;
    return new DisplayModePtr(r);
  }
   ...
   */
  static forPoint(point: _r.Point): Display | null {
   ...
   */
  static forRect(rect: _r.Rect): Display | null {
    const buf = new Uint32Array(4);
...
export class Window {
  ...
  get display(): Display | null {
    const r = SDL.getDisplayForWindow(this.pointer);
    if (r === 0) return null;
    return new Display(r);
  }
  ...
  get pixelDensity(): number {
    return SDL.getWindowPixelDensity(this.pointer);
  }
  ...
  get displayScale(): number {
    return SDL.getWindowDisplayScale(this.pointer);
  }
   ...
   */
  get fullscreenMode(): DisplayModePtr | null {
   ...
   */
  get IccProfile(): { data: Deno.PointerObject; size: bigint } | null {
  ...
  get pixelFormat(): number {
    return SDL.getWindowPixelFormat(this.pointer);
  }
   ...
   */
  static get windows(): Window[] | null {
   ...
   */
  static createWithProperties(props: number): Window | null {
   ...
   */
  static fromId(id: number): Window | null {
  ...
  setTitle(title: string): boolean {
    return SDL.setWindowTitle(this.pointer, cstr(title));
  }
   ...
   */
  get title(): string {
    return read_cstr(SDL.getWindowTitle(this.pointer));
  }
   ...
   */
  get aspectRatio(): { min_aspect: number; max_aspect: number } | null {
   ...
   */
  get sizeInPixels(): { w: number; h: number } | null {
    const w = new Int32Array(1);
    const h = new Int32Array(1);
    if (
   ...
   */
  get minimumSize(): { w: number; h: number } | null {
    const w = new Int32Array(1);
    const h = new Int32Array(1);
    if (
   ...
   */
  get maximumSize(): { w: number; h: number } | null {
    const w = new Int32Array(1);
    const h = new Int32Array(1);
    if (
  ...
  hide(): boolean {
    return SDL.hideWindow(this.pointer);
  }
  ...
  updateSurfaceRects(rects: _r.Rect[]): boolean {
    const buf = new Uint32Array(4 * rects.length);
    const numrects = rects.length;
    for (let i = 0; i < numrects; i++) {
      _r.write_Rect(rects[i], new DataView(buf.buffer, i * 4));
    }
    return SDL.updateWindowSurfaceRects(
      this.pointer,
      Deno.UnsafePointer.of(buf),
      numrects,
    );
   ...
   */
  static get grabbed(): Window | null {
   ...
   */
  get mouseRect(): _r.Rect | null {
    const r = SDL.getWindowMouseRect(this.pointer);
    if (!r) return null;
...
export class GL {
  ...
  static loadLibrary(path: string): boolean {
    return SDL.glLoadLibrary(cstr(path));
  }
  /**
  ...
  static getProcAddress(proc: string): Deno.PointerValue {
    return SDL.glGetProcAddress(cstr(proc));
  }
  ...
  static eglGetProcAddress(proc: string): Deno.PointerValue {
    return SDL.eglGetProcAddress(cstr(proc));
  }
  ...
  static extensionSupported(extension: string): boolean {
    return SDL.glExtensionSupported(cstr(extension));
  }
   ...
   */
  static getAttribute(attr: number): number | null {
    const buf = new Uint32Array(1);
    const r = SDL.glGetAttribute(attr, Deno.UnsafePointer.of(buf));
    if (!r) return null;
    return buf[0];
  }
   ...
   */
  static glGetCurrentWindow(): Window | null {
   ...
   */
  static glGetSwapInterval(): number | null {
    const buf = new Uint32Array(1);
    const r = SDL.glGetSwapInterval(Deno.UnsafePointer.of(buf));
    if (!r) return null;
    return buf[0];
  }
