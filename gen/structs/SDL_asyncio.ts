...
export const SDL_AsyncIOOutcome = new _.Struct({
  ...
  type: _.u32, /**< SDL_AsyncIOTaskType : What sort of task was this? Read, write, etc? */
  result: _.u32, /**< SDL_AsyncIOResult : the result of the work (success, failure, cancellation). */
  buffer: _.u64, /**< void * : buffer where data was read/written. */
  offset: _.u64, /**< Uint64 : offset in the SDL_AsyncIO where data was read/written. */
  bytes_requested: _.u64, /**< Uint64 : number of bytes the task was to read/write. */
  bytes_transferred: _.u64, /**< Uint64 : actual number of bytes that were read/written. */
  userdata: _.u64, /**< void * : pointer provided by the app when starting the task */
});
